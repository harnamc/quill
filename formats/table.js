...
TableContainer.allowedChildren = [TableBody, THead];
TableBody.requiredContainer = TableContainer;
THead.requiredContainer = TableContainer;

TableBody.allowedChildren = [TableRow];
TableRow.requiredContainer = TableBody;

THead.allowedChildren = [HeadRow];
HeadRow.requiredContainer = THead;
